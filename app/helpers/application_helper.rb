...
module ApplicationHelper
  ...
  def sortable(column, title = nil)
    ...
    %w(page search filter alias period name funding overdue repaid active user_name loan_name borrower_name rating columns only_funding).each { |p| link_parameters.merge!( {p.to_sym => params[p]} )}
